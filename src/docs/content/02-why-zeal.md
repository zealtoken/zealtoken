...
**2. Every launch on [zealz.fun](#/launchpad).** Tokens launched there trade against zZEC, and their hook sends at least 0.5% of the zZEC side of every trade to the same Furnace, up to 4% if the creator chooses. A hundred launched tokens are a hundred pools feeding the burn, and the burn does not care whether any of them succeed.
...
- **Launches on zealz.fun.** Each one is a new pool paying between 0.5% and 4% of every trade to the Furnace.
