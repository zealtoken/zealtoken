...
os.umask(0o077)
if not pathlib.Path('/etc/zeal/WRAP_INTERIM_TEST').is_file():raise SystemExit('Controlled test gate missing')
p=pathlib.Path('/run/zeal/wrap-deposit-test')
try:
