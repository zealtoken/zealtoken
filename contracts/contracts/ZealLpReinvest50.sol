...
/// @notice Reinvests half of ONE wallet-owned position's fees. The NFT stays with its owner.
...
contract ZealLpReinvest50 is ReentrancyGuard {
    using SafeERC20 for IERC20;
    uint256 private constant Q96 = 1 << 96;
    uint256 public constant REINVEST_BPS = 5000;
    ...
    /// @notice Use eth_call for a fee preview. Executing splits newly collected fees 50/50.
